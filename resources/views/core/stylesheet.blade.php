...
<link rel="stylesheet" href="{{ asset('') }}dist/assets/modules/bootstrap-daterangepicker/daterangepicker.css">
  <link rel="stylesheet" href="{{ asset('') }}dist/assets/modules/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css">
  <link rel="stylesheet" href="{{ asset('') }}dist/assets/modules/select2/dist/css/select2.min.css">
  <link rel="stylesheet" href="{{ asset('') }}dist/assets/modules/jquery-selectric/selectric.css">
...
<!-- DataTables -->
<link rel="stylesheet" href="{{ asset('') }}dist/assets/modules/datatables-bs4/css/dataTables.bootstrap4.min.css">
<link rel="stylesheet" href="{{ asset('') }}dist/assets/modules/datatables-responsive/css/responsive.bootstrap4.min.css">
<link rel="stylesheet" href="{{ asset('') }}dist/assets/modules/datatables-buttons/css/buttons.bootstrap4.min.css">
<!-- Template CSS -->
