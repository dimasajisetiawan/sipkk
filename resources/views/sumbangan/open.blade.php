...
<div class="section-header">
    <h1>Buka Sumbangan</h1>
  </div>
<div class="row">
    <div class="col-lg-12">
    <div class="card">
        <div class="card-header">
          <h4>Form Buka Sumbangan</h4>
        </div>
        <div class="card-body">
            <form action="/bukasumbangan" method="post">
                @csrf
            <div class="form-group">
                <label>Tanggal Buka</label>
                <input type="text" class="form-control datepicker @error('tgl_buka') is-invalid
                @enderror" id="tgl_buka" name="tgl_buka"
                required autofocus value="{{ old('tgl_buka') }}">
                @error('tgl_buka')
            ...
            <div class="form-group">
                ...
                required autofocus value="{{ old('tgl_tutup') }}">
                @error('tgl_tutup')
                    <div class="invalid-message">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group">
                ...
                required autofocus value="{{ old('kode_kegiatan') }}">
                @error('kode_kegiatan')
                    <div class="invalid-message">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group">
                ...
                required autofocus value="{{ old('nama_kegiatan') }}">
                @error('nama_kegiatan')
                    <div class="invalid-message">
                        {{ $message }}
                    </div>
